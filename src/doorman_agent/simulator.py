...
'''
    ...
    def enqueue_tasks(self, count: int = 1, task_type: str = "quick") -> bool:
        ...
        try:
            client = redis.from_url(f"redis://localhost:{self.redis_port}/0", decode_responses=True)
                ...
                task_message = json.dumps(
                    {
                        ...
                        "properties": {"correlation_id": task_id, "delivery_tag": task_id},
